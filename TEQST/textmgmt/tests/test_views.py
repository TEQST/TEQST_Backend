...
class TestSharedFolderStatsView(TestCase):
    ...
    def test_stats_user_is_not_a_publisher(self):
    ...
    def test_stats_folder_is_not_shared(self):
        # setup
        user1 = get_user(1)
        user2 = get_user(2)
        f1 = Folder.objects.create(name='f1', owner=user1)
